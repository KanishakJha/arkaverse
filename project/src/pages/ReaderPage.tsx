...
export function ReaderPage() {
  ...
  // ElevenLabs Dynamic Stream Controller with Premium System Default Voice Swapping
  useEffect(() => {
    async function playCurrentChunk() {
      ...
      try {
        ...
        // 🚀 Switching to the most stable baseline multilingual model
        const modelId = "eleven_multilingual_v2"
        
        // 🔥 SYSTEM DEFAULT HARDCODED UNBREAKABLE VOICE IDs
        // Male ID: 'IKne3meq5aSn9XLyUdCD' (Charlie - Deep Heavy Male Voice)
        // Female ID: '21m00Tcm4TlvDq8ikWAM' (Rachel - Standard Clear Female Voice)
        let voiceId = "IKne3meq5aSn9XLyUdCD" // Default Male
        ...
        const response = await fetch(`https://api.elevenlabs.io/v1/text-to-speech/${voiceId}`, {
          ...
          body: JSON.stringify({
            ...
            model_id: modelId,
            voice_settings: { 
              stability: 0.50, // Standard balance point to stop robotic override
